  ...
  const form: Form = {
    ...
    submit: {
      ...
      handler: async (data, passby) => {
        ...
        const tAction = await getTranslations('admin.categories');
        ...
        const result = await updateTaxonomy(id, updateCategory);

        if (!result) {
          throw new Error(tAction('edit.messages.error_update'));
        }

        return {
          status: 'success',
          message: tAction('edit.messages.success_update'),
