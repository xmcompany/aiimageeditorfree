        ...
        <div className="@container relative container">
          <ScrollAnimation>
            <div className="mx-auto max-w-2xl text-center">
              <span className="text-primary font-bold uppercase tracking-wider">{section.label}</span>
              <h2 className="text-foreground mt-4 text-4xl font-serif font-extrabold tracking-tight lg:text-5xl">
                {section.title}
              </h2>
              <p className="text-muted-foreground mt-6 text-lg text-balance opacity-90 leading-relaxed">
                {section.description}
              </p>
            </div>
          </ScrollAnimation>
