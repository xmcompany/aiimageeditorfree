      ...
      >
        <div
          className={cn(
            ...
            'in-data-scrolled:border-b in-data-scrolled:bg-background/80 in-data-scrolled:backdrop-blur-xl in-data-scrolled:shadow-md dark:in-data-scrolled:shadow-black/20',
                  ...
                  {header.buttons &&
                    header.buttons.map((button, idx) => (
                      <Link
                        ...
                        className={cn(
                          'focus-visible:ring-ring inline-flex items-center justify-center gap-2 rounded-[var(--radius)] text-sm font-semibold whitespace-nowrap transition-all focus-visible:ring-1 focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50',
                          'h-9 px-4 ring-0 hover:scale-105 active:scale-95',
                          button.variant === 'outline'
                            ? 'bg-background/50 border-primary/20 backdrop-blur-sm hover:bg-primary/10 border shadow-sm duration-200'
