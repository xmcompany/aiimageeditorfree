  ...
  return (
    ...
    >
      ...
      >
        ...
        <p className="text-muted-foreground text-md mx-auto mb-4 line-clamp-3 max-w-full md:max-w-2xl lg:text-lg opacity-90">
          {section.description}
        </p>
      ...
      {filteredItems.length > 0 ? (
        <div className="container mx-auto columns-1 gap-4 space-y-4 sm:columns-2 lg:columns-3 xl:columns-4">
          {filteredItems.map((item, index) => (
            <motion.div
              key={index}
              className="group relative cursor-zoom-in break-inside-avoid overflow-hidden rounded-[var(--radius)]"
                ...
                <div className="relative max-h-full max-w-full overflow-hidden rounded-lg">
                  ...
                  <div className="absolute right-0 bottom-0 left-0 bg-gradient-to-t from-black/80 via-black/50 to-transparent p-6 text-white">
                    <h3 className="mb-2 text-2xl font-bold">
                      {(filteredItems[selectedIndex] as any).title || filteredItems[selectedIndex].title || (filteredItems[selectedIndex] as any).prompt}
                    </h3>
