        ...
        <div className="flex flex-wrap items-center gap-8 pb-12 md:gap-24">
          ...
          <div className="w-full min-w-0 flex-1">
            <ScrollAnimation delay={0.1}>
              <h2 className="text-foreground text-4xl font-serif font-extrabold tracking-tight text-pretty break-words lg:text-5xl">
                {section.title}
              </h2>
            </ScrollAnimation>
            <ScrollAnimation delay={0.2}>
              <p className="text-muted-foreground my-6 text-lg opacity-90 leading-relaxed text-pretty break-words">
                {section.description}
              </p>
            </ScrollAnimation>
